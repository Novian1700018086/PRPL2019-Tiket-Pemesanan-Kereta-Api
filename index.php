...
<form method="post" action="aksi.php" id="modal1" class="modal" style="width:300px">
    <div class="modal-content">
        ...
        <div class="row">
            <div class="input-field col s12">
                <input id="kelas" type="text" class="validate" name="kelas" required>
                <label for="kelas">Kelas</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12">
                <input id="harga" type="text" class="validate" name="harga" required>
                <label for="harga">Harga</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12">
                <input id="tanggal" type="date" class="validate" name="tanggal" required>
                <label for="tanggal">Tanggal Brangkat</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12">
                <input id="waktu" type="time" class="validate" name="waktu" required>
...
<div id="modal-transaksi" class="modal" style="width:300px">
    <div class="modal-content">
        ...
        <div class="row">
            <div class="input-field col s12">
                <input id="harga" type="text" class="validate" name="harga" onfocus="mulaiHitung()" onblur="berhentiHitung()">
                <label class="active" for="harga">Harga</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12">
                <input id="jml_pesan" type="text" class="validate" name="jml_pesan" onfocus="mulaiHitung()" onblur="berhentiHitung()">
                <label for="jml_pesan">Jumlah Pesan</label>
            </div>
        </div>
        <div class="row">
            <div class="field-warp">
                <input id="tot_bayar" type="text" class="validate" name="tot_bayar" onfocus="mulaiHitung()" onblur="berhentiHitung()">
                <label class="active" for="tot_bayar">Total Bayar</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12">
                <input id="diskon" type="text" class="validate" name="diskon" onfocus="mulaiHitung()" onblur="berhentiHitung()">
                <label for="diskon">Diskon</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12">
                <input id="tot_setdiskon" type="text" class="validate" name="tot_setdiskon" onfocus="mulaiHitung()" onblur="berhentiHitung()">
                <label for="tot_setdiskon">Total Setelah Diskon</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12">
                <input id="bayar" type="text" class="validate" name="bayar" onfocus="mulaiHitung()" onblur="berhentiHitung()">
                <label class="active" for="bayar">Bayar</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12">
                <input id="kembalian" type="text" class="validate" name="kembalian" onfocus="mulaiHitung()" onblur="berhentiHitung()">
                <label class="active" for="kembalian">Kembalian</label>
            </div>
        </div>
    </div>
    <div class="modal-footer">
        <button type="button" class="btn blue waves-effect waves-light btn-transaksi" name="transaksi2">Submit<i class="material-icons right">send</i></button>
    </div>
</div>
...
<form method="post" action="aksi.php" id="modal-transaksi-preview" class="modal">
    ...
    <div class="modal-footer">
        <button type="submit" class="btn blue waves-effect waves-light" name="transaksi2">Submit<i class="material-icons right">send</i></button>
    </div>
</form>
